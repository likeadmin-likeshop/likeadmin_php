          ...
          <el-form ref="formRef" :model="formData" label-width="180px" :rules="formRules">
            ...
            <div v-if="formData.engine !== 'local'">
              <el-form-item label=" 存储空间名称(Bucket)" prop="bucket">
                <div class="w-80">
                  <el-input v-model="formData.bucket" placeholder="请输入存储空间名称(Bucket)" />
                </div>
              </el-form-item>
              <el-form-item label="ACCESS_KEY（AK）" prop="access_key">
                <div class="w-80">
                  <el-input v-model="formData.access_key" placeholder="请输入ACCESS_KEY" />
                </div>
              </el-form-item>
              ...
              <el-form-item label="空间域名（Domain）" prop="domain">
                <div>
                  <div class="w-80">
                    <el-input v-model="formData.domain" placeholder="请输入空间域名" />
                  </div>
