    ...
    <div class="website-filing">
        <el-card shadow="never" class="">
            <el-form :rules="rules" ref="form" class="ls-form" :model="form" label-width="150px" size="small">
                ...
                <!--公安备案号输入框 -->
                <el-form-item label="公安备案号" prop="password">
                    <el-input v-model="formData.public_number" show-password placeholder="请输入公安备案号"></el-input>
                </el-form-item>

                <!-- 公安备案号链接输入框 -->
                <el-form-item label="公安备案号链接" prop="passwordConfirm">
                    <el-input v-model="formData.public_link" show-password placeholder="请输入公安备案号链接"></el-input>
