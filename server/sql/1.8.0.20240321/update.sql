...
UPDATE `la_decorate_page` SET `type` = 3, `name` = '客服设置', `data` = '[{\"title\":\"客服设置\",\"name\":\"customer-service\",\"content\":{\"title\":\"添加客服二维码\",\"time\":\"早上 9:30 - 19:00\",\"mobile\":\"1888888888\",\"qrcode\":\"/resource/image/adminapi/default/kefu01.png\",\"remark\":\"长按添加客服或拨打客服热线\"},\"styles\":{}}]', `meta` = '', `create_time` = 1661757188, `update_time` = 1710929953 WHERE `id` = 3;
