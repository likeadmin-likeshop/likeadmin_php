...
const styles = {
  "pages/account/security.vue": () => import('./_nuxt/security-styles.6924c813.mjs').then(interopDefault),
  "node_modules/@nuxt/ui-templates/dist/templates/error-404.vue": () => import('./_nuxt/error-404-styles.d2a508fc.mjs').then(interopDefault),
  "node_modules/@nuxt/ui-templates/dist/templates/error-500.vue": () => import('./_nuxt/error-500-styles.0aab1d62.mjs').then(interopDefault),
  "pages/user/info.vue": () => import('./_nuxt/info-styles.c9355d34.mjs').then(interopDefault),
