import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, toRef, isRef, inject, warn, isVNode, computed, unref, shallowRef, defineComponent, openBlock, createElementBlock, mergeProps, renderSlot, onUnmounted, useAttrs as useAttrs$1, useSlots, nextTick, withDirectives, createCommentVNode, Fragment, normalizeClass, createElementVNode, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, normalizeStyle, vShow, Transition, provide, reactive, shallowReactive, useSSRContext, Text, createApp, render, effectScope, isReactive, toRaw, toRefs, h, Suspense, onErrorCaptured, onServerPrefetch, getCurrentScope, onScopeDispose, isReadonly, defineAsyncComponent, markRaw, isShallow, resolveComponent, withKeys, createTextVNode } from 'vue';
...
import { merge, isFunction as isFunction$1, isObject as isObject$1 } from 'lodash-es';
import { isClient, useEventListener, useResizeObserver, useTimeoutFn } from '@vueuse/core';
import { isString, isObject, hasOwn, NOOP, isArray, isFunction, camelize, hyphenate } from '@vue/shared';
...
const defaultNamespace$1 = _globalThis[globalKey$1] || (_globalThis[globalKey$1] = createNamespace());
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/security-e810e99d.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-2de5922e.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-40615dcc.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-29519a69.mjs').then((m) => m.default || m)
  },
  {
    name: "information",
    path: "/information",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c8167056.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/_type_-3b95b0e7.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/collection-b5e6a70c.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/info-3e52897a.mjs').then((m) => m.default || m)
  }
];
...
const isEmptyObject = (target) => {
  return isObject$1(target) && !Object.keys(target).length;
};
...
var ElFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$1], ["__file", "focus-trap.vue"]]);
...
var Badge = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "badge.vue"]]);
...
var NotificationConstructor = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "notification.vue"]]);
const notifications = {
  "top-left": [],
  "top-right": [],
  "bottom-left": [],
...
const layouts = {
  ...
  default: () => import('./_nuxt/default-e5e5797a.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-b466990f.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-f5a20a87.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { scale_to_original_default as $, close_default as A, useLocale as B, useId as C, isKorean as D, ElButton as E, useDeprecated as F, useFocusController as G, useFormItem as H, useFormItemInputId as I, isUndefined as J, EVENT_CODE as K, LOCAL_ICON_PREFIX as L, scrollIntoView as M, CHANGE_EVENT as N, useSizeProp as O, circle_close_default as P, arrow_down_default as Q, ElInput as R, mutable as S, d_arrow_left_default as T, UPDATE_MODEL_EVENT as U, ValidateComponentsMap as V, more_filled_default as W, d_arrow_right_default as X, addUnit as Y, full_screen_default as Z, _export_sfc as _, useAccount as a, useZIndex as a0, zoom_out_default as a1, zoom_in_default as a2, refresh_left_default as a3, refresh_right_default as a4, keysOf as a5, useAttrs as a6, isElement as a7, getScrollContainer as a8, userEdit as a9, PopupTypeEnum as aa, logout as ab, useNuxtApp as ac, useRouter as ad, navigateTo as ae, buildProp as af, isBoolean as ag, useGetDerivedNamespace as ah, useIdInjection as ai, throwError as aj, formItemContextKey as ak, ElFocusTrap as al, FOCUS_TRAP_INJECTION_KEY as am, addClass as an, removeClass as ao, hasClass as ap, more_default as aq, search_default as ar, useState as as, isExternal as at, useHead as au, userChangePwd as b, createError as c, buildProps as d, entry$1 as default, debugWarn as e, flattedChildren as f, getUserInfo as g, useNamespace as h, isNumber as i, ElIcon as j, arrow_left_default as k, arrow_right_default as l, withNoopInstall as m, useAppStore as n, useRoute as o, iconPropType as p, definePropType as q, feedback as r, EL_ICON_PREFIX as s, view_default as t, useUserStore as u, vLoading as v, withInstall as w, getPolicy as x, componentSizes as y, useFormSize as z };
