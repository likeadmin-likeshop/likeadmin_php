...
import { j as ElIcon, t as view_default } from '../server.mjs';
                ...
                if (__props.showClick) {
                  ...
                  _push2(ssrRenderComponent(unref(ElIcon), null, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(ssrRenderComponent(unref(view_default), null, null, _parent3, _scopeId2));
                      } else {
                        return [
...
//# sourceMappingURL=items-e56c0477.mjs.map
