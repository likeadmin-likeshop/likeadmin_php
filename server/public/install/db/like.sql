...
-- ----------------------------
BEGIN;
INSERT INTO `la_article_cate` (`id`, `name`, `sort`, `is_show`, `create_time`, `update_time`, `delete_time`) VALUES (1, '文章资讯', 0, 1, 1663317280, 1663317280, 1663317282), (2, '社会热点', 0, 1, 1663317280, 1663321464, 1663321494);
COMMIT;
