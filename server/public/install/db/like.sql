...
CREATE TABLE `ls_system_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表';

-- ----------------------------
-- Records of ls_system_menu
-- ----------------------------
BEGIN;
INSERT INTO `ls_system_menu` VALUES (4, 0, 'M', '权限管理', 'el-icon-Lock', 800, '', 'permission', '', '', '', 0, 1, 0, 1656664556, 1658989382), (5, 0, 'C', '工作台', 'el-icon-Monitor', 1000, 'workbench/index', 'workbench', 'workbench/index', '', '', 0, 1, 0, 1656664793, 1658989243), (6, 4, 'C', '菜单', 'el-icon-Operation', 1, 'auth.menu/lists', 'menu', 'permission/menu/index', '', '', 1, 1, 0, 1656664960, 1658989504), (7, 4, 'C', '管理员', 'local-icon-member', 1, 'auth.admin/lists', 'admin', 'permission/admin/index', '', '', 0, 1, 0, 1656901567, 1658989587), (8, 4, 'C', '角色', 'local-icon-set-user', 1, 'auth.role/lists', 'role', 'permission/role/index', '', '', 0, 1, 0, 1656901660, 1658989634), (12, 8, 'A', '新增角色', '', 1, 'auth.role/add', '', '', '', '', 0, 1, 0, 1657001790, 1657073691), (14, 8, 'A', '编辑角色', '', 1, 'auth.role/edit', '', '', '', '', 0, 1, 0, 1657001924, 1657073676), (15, 8, 'A', '删除角色', '', 1, 'auth.role/delete', '', '', '', '', 0, 1, 0, 1657001982, 1657073665), (16, 6, 'A', '新增菜单', '', 1, 'auth.menu/add', '', '', '', '', 0, 1, 0, 1657072523, 1657072523), (17, 6, 'A', '编辑菜单', '', 1, 'auth.menu/edit', '', '', '', '', 0, 1, 0, 1657073955, 1657073955), (18, 6, 'A', '删除菜单', '', 1, 'auth.menu/delete', '', '', '', '', 0, 1, 0, 1657073987, 1657074002), (19, 7, 'A', '新增管理员', '', 1, 'auth.admin/add', '', '', '', '', 0, 1, 0, 1657074035, 1657074035), (20, 7, 'A', '编辑管理员', '', 1, 'auth.admin/edit', '', '', '', '', 0, 1, 0, 1657074071, 1657074071), (21, 7, 'A', '删除管理员', '', 1, 'auth.admin/delete', '', '', '', '', 0, 1, 0, 1657074108, 1657074108), (23, 0, 'M', '开发工具', 'el-icon-EditPen', 900, '', 'dev_tools', '', '', '', 0, 1, 0, 1657097744, 1658989289), (24, 23, 'C', '代码生成器', 'el-icon-DocumentAdd', 1, 'tools.generator/generateTable', 'code', 'dev_tools/code/index', '', '', 0, 1, 0, 1657098110, 1658989423), (25, 0, 'M', '组织管理', 'el-icon-User', 700, '', 'organization', '', '', '', 0, 1, 0, 1657099914, 1657507220), (26, 25, 'C', '部门管理', 'el-icon-Coordinate', 1, 'dept.dept/lists', 'department', 'organization/department/index', '', '', 0, 1, 0, 1657099989, 1658989663), (27, 25, 'C', '岗位管理', 'el-icon-PriceTag', 1, 'dept.jobs/lists', 'post', 'organization/post/index', '', '', 0, 1, 0, 1657100044, 1658989726), (28, 0, 'M', '系统设置', 'el-icon-Setting', 500, '', 'setting', '', '', '', 0, 1, 0, 1657100164, 1658989887), (29, 28, 'M', '网站设置', 'el-icon-Basketball', 1, '', 'website', '', '', '', 0, 1, 0, 1657100230, 1658989861), (30, 29, 'C', '网站信息', '', 1, 'setting.web.web_setting/getWebsite', 'information', 'setting/website/information', '', '', 0, 1, 0, 1657100306, 1657164412), (31, 29, 'C', '网站备案', '', 1, 'setting.web.web_setting/getCopyright', 'filing', 'setting/website/filing', '', '', 0, 1, 0, 1657100434, 1657164723), (32, 29, 'C', '政策协议', '', 1, 'setting.web.web_setting/getAgreement', 'protocol', 'setting/website/protocol', '', '', 0, 1, 0, 1657100571, 1657164770), (33, 28, 'C', '存储设置', 'el-icon-FolderOpened', 1, 'setting.storage/lists', 'storage', 'setting/storage/index', '', '', 0, 1, 0, 1657160959, 1658989894), (34, 28, 'C', '字典管理', 'el-icon-Box', 1, 'setting.dict.dict_type/lists', 'dict', 'setting/dict/type/index', '', '', 0, 1, 0, 1657161211, 1658989785), (35, 28, 'M', '系统维护', 'el-icon-SetUp', 1, '', 'system', '', '', '', 0, 1, 0, 1657161569, 1658989938), (36, 35, 'C', '系统日志', '', 1, 'setting.system.log/lists', 'journal', 'setting/system/journal', '', '', 0, 1, 0, 1657161696, 1657165722), (37, 35, 'C', '系统缓存', '', 1, '', 'cache', 'setting/system/cache', '', '', 0, 1, 0, 1657161896, 1657173767), (38, 35, 'C', '系统环境', '', 1, 'setting.system.system/info', 'environment', 'setting/system/environment', '', '', 0, 1, 0, 1657162000, 1657173794), (39, 24, 'A', '导入数据表', '', 1, 'tools.generator/selectTable', '', '', '', '', 0, 1, 0, 1657162736, 1657162736), (40, 24, 'A', '代码生成', '', 1, 'tools.generator/generate', '', '', '', '', 0, 1, 0, 1657162806, 1657162806), (41, 24, 'A', '编辑数据表', '', 1, 'tools.generator/edit', '', '', '', '', 0, 1, 0, 1657162866, 1657163032), (42, 24, 'A', '同步表结构', '', 1, 'tools.generator/syncColumn', '', '', '', '', 0, 1, 0, 1657162934, 1657162934), (43, 24, 'A', '删除数据表', '', 1, 'tools.generator/delete', '', '', '', '', 0, 1, 0, 1657163015, 1657163015), (44, 24, 'A', '预览代码', '', 1, 'tools.generator/preview', '', '', '', '', 0, 1, 0, 1657163263, 1657163263), (45, 26, 'A', '新增部门', '', 1, 'dept.dept/add', '', '', '', '', 0, 1, 0, 1657163548, 1657163548), (46, 26, 'A', '编辑部门', '', 1, 'dept.dept/edit', '', '', '', '', 0, 1, 0, 1657163599, 1657163599), (47, 26, 'A', '删除部门', '', 1, 'dept.dept/delete', '', '', '', '', 0, 1, 0, 1657163687, 1657163687), (48, 27, 'A', '新增岗位', '', 1, 'dept.jobs/add', '', '', '', '', 0, 1, 0, 1657163778, 1657163778), (49, 27, 'A', '编辑岗位', '', 1, 'dept.jobs/edit', '', '', '', '', 0, 1, 0, 1657163800, 1657163800), (50, 27, 'A', '删除岗位', '', 1, 'dept.jobs/delete', '', '', '', '', 0, 1, 0, 1657163820, 1657163820), (51, 30, 'A', '保存网站信息', '', 1, 'setting.web.web_setting/setWebsite', '', '', '', '', 0, 1, 0, 1657164469, 1657164469), (52, 31, 'A', '保存网站备案', '', 1, 'setting.web.web_setting/setCopyright', '', '', '', '', 0, 1, 0, 1657164692, 1657164692), (53, 32, 'A', '保存政策协议', '', 1, 'setting.web.web_setting/setAgreement', '', '', '', '', 0, 1, 0, 1657164824, 1657164824), (54, 33, 'A', '设置存储', '', 1, 'setting.storage/setup', '', '', '', '', 0, 1, 0, 1657165303, 1657165303), (55, 34, 'A', '新增字典类型', '', 1, 'setting.dict.dict_type/add', '', '', '', '', 0, 1, 0, 1657166966, 1657166966), (56, 34, 'A', '编辑字典类型', '', 1, 'setting.dict.dict_type/edit', '', '', '', '', 0, 1, 0, 1657166997, 1657166997), (57, 34, 'A', '删除字典类型', '', 1, 'setting.dict.dict_type/delete', '', '', '', '', 0, 1, 0, 1657167038, 1657167038), (58, 34, 'A', '新增字典数据', '', 1, 'setting.dict.dict_data/add', '', '', '', '', 0, 1, 0, 1657167317, 1657167317), (59, 34, 'A', '编辑字典数据', '', 1, 'setting.dict.dict_data/edit', '', '', '', '', 0, 1, 0, 1657167371, 1657167371), (60, 34, 'A', '删除字典数据', '', 1, 'setting.dict.dict_data/delete', '', '', '', '', 0, 1, 0, 1657167397, 1657167397), (61, 37, 'A', '清除系统缓存', '', 1, 'setting.system.cache/clear', '', '', '', '', 0, 1, 0, 1657173837, 1657173939), (62, 34, 'A', '字典数据管理', '', 1, 'setting.dict.dict_data/lists', '', '', '', '', 0, 1, 0, 1657174351, 1657174351), (63, 0, 'M', '素材管理', 'el-icon-Picture', 600, '', 'material', '', '', '', 0, 1, 0, 1657507133, 1658989310), (64, 63, 'C', '素材中心', 'local-icon-picture-1', 1, '', 'index', 'material/index', '', '', 0, 1, 0, 1657507296, 1658989835);
COMMIT;
